...
public class CPU {
    ...
    public void initializeGeneralRegisters() throws IOException{
        String[] generalRegistersLines = new ConfigReader().readFile(System.getProperty("user.dir") + "\\src\\Backend\\ConfigFiles\\GeneralRegisters.txt");
    ...
    public void initializeCPURegisters() throws IOException{
        String[] CPURegistersLines = new ConfigReader().readFile(System.getProperty("user.dir") + "\\src\\Backend\\ConfigFiles\\CPURegisters.txt");
    ...
    public void initializeCPUOperations() throws IOException{
        String[] CPUOperationsLines = new ConfigReader().readFile(System.getProperty("user.dir") + "\\src\\Backend\\ConfigFiles\\Operations.txt");
